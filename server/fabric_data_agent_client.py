...
# Override standard print in this module to log to stderr instead of stdout.
# This prevents debug/auth/status messages from polluting stdout, which is
# captured by Node.js to retrieve the final technical specification result.
...
class FabricDataAgentClient:
    ...
    def _get_openai_client(self) -> OpenAI:
        ...
        return OpenAI(
            api_key="dummy",  # Not used - we use Bearer token
    ...
    def _get_existing_or_create_new_thread(self, data_agent_url: str, thread_name = None) -> dict:
        ...
        response = requests.get(get_new_thread_url, headers=headers, verify=False)
